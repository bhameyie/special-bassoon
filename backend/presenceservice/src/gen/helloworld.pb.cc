...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, namey_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_helloworld_2eproto = {
  false, false, descriptor_table_protodef_helloworld_2eproto, "helloworld.proto", 189,
...
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  namey_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_namey().empty()) {
    namey_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_namey(),
      GetArena());
  }
...
void HelloRequest::SharedDtor() {
  ...
  namey_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_namey();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "helloworld.HelloRequest.namey"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* HelloRequest::_InternalSerialize(
  ...
  // string namey = 2;
  if (this->namey().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_namey().data(), static_cast<int>(this->_internal_namey().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "helloworld.HelloRequest.namey");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_namey(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:helloworld.HelloRequest)
  ...
  if (from.namey().size() > 0) {
    _internal_set_namey(from._internal_namey());
  }
}
...
void HelloRequest::InternalSwap(HelloRequest* other) {
  ...
  namey_.Swap(&other->namey_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
