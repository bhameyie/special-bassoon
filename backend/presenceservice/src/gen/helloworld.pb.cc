...
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  if (!from._internal_namey().empty()) {
    namey_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.namey_);
  }
...
void HelloRequest::InternalSwap(HelloRequest* other) {
  ...
  name_.Swap(&other->name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  namey_.Swap(&other->namey_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
}
