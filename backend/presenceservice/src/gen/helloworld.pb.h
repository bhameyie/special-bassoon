...
inline void HelloRequest::clear_namey() {
  namey_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void HelloRequest::_internal_set_namey(const std::string& value) {
  ...
  namey_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void HelloRequest::set_namey(const char* value) {
  ...
  namey_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void HelloRequest::set_namey(const char* value,
  ...
  namey_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* HelloRequest::_internal_mutable_namey() {
  ...
  return namey_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* HelloRequest::release_namey() {
  // @@protoc_insertion_point(field_release:helloworld.HelloRequest.namey)
  return namey_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void HelloRequest::set_allocated_namey(std::string* namey) {
  ...
  namey_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), namey,
      GetArena());
