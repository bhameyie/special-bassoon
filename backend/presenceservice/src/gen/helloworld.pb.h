...
class HelloRequest :
 ...
 public:
  ...
  void set_namey(const std::string& value);
  void set_namey(std::string&& value);
  void set_namey(const char* value);
  void set_namey(const char* value, size_t size);
  std::string* mutable_namey();
  std::string* release_namey();
  void set_allocated_namey(std::string* namey);
  private:
  const std::string& _internal_namey() const;
  void _internal_set_namey(const std::string& value);
  std::string* _internal_mutable_namey();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr namey_;
...
// string namey = 2;
inline void HelloRequest::clear_namey() {
  namey_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& HelloRequest::namey() const {
  // @@protoc_insertion_point(field_get:helloworld.HelloRequest.namey)
  return _internal_namey();
}
inline void HelloRequest::set_namey(const std::string& value) {
  _internal_set_namey(value);
  // @@protoc_insertion_point(field_set:helloworld.HelloRequest.namey)
}
inline std::string* HelloRequest::mutable_namey() {
  // @@protoc_insertion_point(field_mutable:helloworld.HelloRequest.namey)
  return _internal_mutable_namey();
}
inline const std::string& HelloRequest::_internal_namey() const {
  return namey_.GetNoArena();
}
inline void HelloRequest::_internal_set_namey(const std::string& value) {
  
  namey_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void HelloRequest::set_namey(std::string&& value) {
  
  namey_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:helloworld.HelloRequest.namey)
}
inline void HelloRequest::set_namey(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  namey_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:helloworld.HelloRequest.namey)
}
inline void HelloRequest::set_namey(const char* value, size_t size) {
  
  namey_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:helloworld.HelloRequest.namey)
}
inline std::string* HelloRequest::_internal_mutable_namey() {
  
  return namey_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* HelloRequest::release_namey() {
  // @@protoc_insertion_point(field_release:helloworld.HelloRequest.namey)
  
  return namey_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void HelloRequest::set_allocated_namey(std::string* namey) {
  if (namey != nullptr) {
    
  } else {
    
  }
  namey_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), namey);
  // @@protoc_insertion_point(field_set_allocated:helloworld.HelloRequest.namey)
}
